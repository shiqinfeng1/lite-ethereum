...
import (
	...
	"github.com/shiqinfeng1/lite-ethereum/common/bitutil"
	"github.com/shiqinfeng1/lite-ethereum/crypto"
	"github.com/shiqinfeng1/lite-ethereum/crypto/ecies"
...
func readHandshakeMsg(msg plainDecoder, plainSize int, prv *ecdsa.PrivateKey, r io.Reader) ([]byte, error) {
	...
	// R.Curve = key.PublicKey.Curve
	// R.X, R.Y = elliptic.Unmarshal(R.Curve, buf[2:(key.PublicKey.Curve.Params().BitSize+7)/4+2])
	// id := enode.PubkeyToIDV4(R.ExportECDSA())
	// log.Printf("@@@ readHandshakeMsg... Remote Node ID: %v", id)
